...
<div id="login" class="effect7">
	  <h2>Assistance Control Log in</h2>
	  <form action="app/php/login.php" method="post" id="frmLogin">
        <div class='label'><?php echo $txt_usuario; ?></div>
        <input type="text" name="usuario" id="usuario" value='<?php echo $u; ?>'/>
        <div style="clear:both; height:10px"></div>
        <div class='label'><?php echo $txt_pass; ?></div>
        <input type="password"  name="pass" value='<?php echo $p; ?>'/>
        <div style="clear:both; height:10px"></div>
